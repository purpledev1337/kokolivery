<template>
  <div id="shop">
    ...
    <div v-if="dishes.length" id="flex">
      <div class="category_box" v-for="category, i in arrayCategories" :key="i"
          :class="{ ant: category == 'Antipasto', pri: category == 'Primi Piatti', sec: category == 'Secondi Piatti', piz: category == 'Pizza', des: category == 'Dessert', bib: category == 'Bibite',}">
        <h2 style="width:100%">{{ category }}: {{ setCat(category) }}</h2>
        <div class="dish_box" v-for="dish, k in arrayCategoryDishes" :key="k">
          <!-- <div v-if="dish.category == arrayCategories[i]"> -->
            <div>
    ...
    <div id="loading_screen" v-else>...Loading screen...</div>
