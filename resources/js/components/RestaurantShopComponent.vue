<template>
  <div class="row" id="shop">
    ...
    <div class="d-none d-md-inline col-md-4" id="cart-box">
      <table>
        <tr>
          <th>Qnt.</th>
          <th>Piatto</th>
    ...
    <!-- dish cards -->
    <div v-if="dishes.length" class="col-xs-12 col-md-8" id="flex">
      <div
        class="category_box"
      ...
      >
        <h2 style="width: 100%">{{ category }}:</h2>
        {{ setCat(category) }}
        <div class="dish_box" v-for="(dish, k) in arrayCategoryDishes" :key="k">
          ...
          <div>
            <div class="dish_card" v-if="dish.is_visible || dish.delete">
              ...
              <span class="btn btn-primary" v-else @click="addToCart(dish)">
