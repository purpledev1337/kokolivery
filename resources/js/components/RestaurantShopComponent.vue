<template>
  <div v-if="dishes.length" id="shop">
    ...
    <div id="content_box" class="row position-relative">
      ...
      <div
        id="dishes_box"
        class="col-xs-12 col-md-8 d-flex flex-column align-items-around"
      >
        <div
          class="category_box"
          v-for="(category, i) in arrayCategories"
      ...
      <div
        :class="!isCartOpen ? 'd-none' : ''"
        class="cart_position col-md-4 d-md-inline-block d-flex flex-column justify-content-between p-3"
        id="cart-box"
      >

          <div class="row p-3">
            <!-- <div class="col-4">Qnt.</div>
            <div class="col-6">Piatto</div>
          ...
          <div class="row" v-for="(item, i) in cart" :key="item.id + i">
            ...
            <div class="col-5 align-self-center">€ {{ item.price }}</div>
          </div>
          <div class="row">
